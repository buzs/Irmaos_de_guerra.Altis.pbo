			...
			default
			{
				["Loja de Recruta / Soldado",
					[
						...
						["ToolKit",nil,250],
						["Medikit",nil,1000],
						["1Rnd_Smoke_Grenade_shell","Granada de Fumaça Branca",2000],
						["1Rnd_SmokeRed_Grenade_shell","Granada de Fumaça Vermelha",2000],
						["1Rnd_SmokeGreen_Grenade_shell","Granada de Fumaça Verde",2000],
						["1Rnd_SmokeYellow_Grenade_shell","Granada de Fumaça Amarela",2000],
						["1Rnd_SmokePurple_Grenade_shell","Granada de Fumaça Roxa",2000],
						["1Rnd_SmokeBlue_Grenade_shell","Granada de Fumaça Azul",2000],
						["1Rnd_SmokeOrange_Grenade_shell","Granada de Fumaça Laranja",2000],
